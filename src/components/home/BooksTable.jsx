...
const BooksTable = ({books}) => {
  return (
   ...
   <td className='border border-slate-700 rounded-md text-center w-20'>
   ...
   <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{book.publishYear}</td>
     ...
     <div className="flex justify-center gap-x-4 border border-slate-600 text-center rounded-md w-full h-8 p-1">
